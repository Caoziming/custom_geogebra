...
(function () {
    ...
    var GGBApplet = function () {
        ...
        applet.setJavaCodebase = applet.setJavaCodebaseVersion = applet.isCompiledInstalled = applet.setPreCompiledScriptPath =
            applet.setPreCompiledResourcePath = function () {};
        applet.setHTML5CodebaseVersion = function (version, offline) {
            var numVersion = parseFloat(version);
            if (numVersion !== NaN && numVersion < 5) {
                console.log("The GeoGebra HTML5 codebase version " + numVersion +
        ...
        applet.inject = function () {
            ...
            function continueInject() {
                ...
                if (type === "screenshot") {
                    ...
                    if (parameters.hasOwnProperty("playButton") && parameters.playButton || parameters.hasOwnProperty(
                            "clickToLoad") && parameters.clickToLoad) {
                        playButton = true
        ...
        var fetchParametersFromApi = function (successCallback) {
            var onSuccess = function (text) {
                ...
                applet.setPreviewImage(previewImagePath || item.previewUrl, imageDir +
                    "GeoGebra_loading.png", imageDir + "applet_play.png");
                successCallback()
            };
            ...
            sendCorsRequest("https://" + host + "/api/proxy.php?path=" + encodeURIComponent(path),
                onSuccess, onError)
        };

        function updateAppletSettings(settings) {
            var parameterNames = ["width", "height", "showToolBar", "showMenuBar", "showAlgebraInput",
                "allowStyleBar", "showResetIcon", "enableLabelDrags", "enableShiftDragZoom",
                "enableRightClick", "appName"];
        ...
        applet.removeExistingApplet = function (appletParent, showScreenshot) {
            ...
            for (i = 0; i < appletParent.childNodes.length; i++) {
                ...
                if (className === "applet_screenshot") {
                    ...
                    removedID = className && className.indexOf("appletParameters") != -1 ? currentChild.id :
                        null;
                    i--
                }
            }
        ...
        var injectHTML5Applet = function (appletElem, parameters, noPreview) {
            ...
            if (!isRenderGGBElementEnabled && !scriptLoadStarted || (ggbHTML5LoadedCodebaseVersion !==
                    html5CodebaseVersion || ggbHTML5LoadedCodebaseIsWebSimple && !html5CodebaseIsWebSimple)) {
                loadScript = true;
            ...
            parameters.disableAutoScale = parameters.disableAutoScale === undefined ? GGBAppletUtils.isFlexibleWorksheetEditor() :
            ...
            var oriAppletOnload = typeof parameters.appletOnLoad === "function" ? parameters.appletOnLoad :
                function () {};
            ...
            function renderGGBElementWithParams(article, parameters) {
                if (parameters && typeof parameters.appletOnLoad === "function" && typeof renderGGBElement ===
                    "function") {
        ...
        var injectScreenshot = function (appletElem, parameters, showPlayButton) {
            ...
            previewPositioner.className = "applet_screenshot applet_scaler" + (showPlayButton ?
                " applet_screenshot_play" : "");
            previewPositioner.appendChild(previewContainer);
        ...
        var getPlayButton = function () {
            ...
            if (!window.GGBT_wsf_view) {
                var css = "" + ".icon-applet-play {" + "   width: 100%;" +
        ...
        var setDefaultHTML5CodebaseForVersion = function (version, offline) {
            ...
            if (index > 0) {
                ...
                codebase = "https://www.geogebra.org/apps/5.2.817.0/"
            }
            ...
            if (!GGBAppletUtils.isFlexibleWorksheetEditor() && hasWebSimple && !views.is3D && !views.AV &&
                !views.SV && !views.CV && !views.EV2 && !views.CP && !views.PC && !views.DA && !views.FI &&
                !views.PV && !valBoolean(parameters.showToolBar) && !valBoolean(parameters.showMenuBar) &&
                !valBoolean(parameters.showAlgebraInput) && !valBoolean(parameters.enableRightClick) && (!
        ...
        var setHTML5CodebaseInternal = function (codebase, offline) {
            ...
            if (html5CodebaseVersion.substr(0, 4) === "test") {
                html5CodebaseVersion = html5CodebaseVersion.substr(4, 1) + "." + html5CodebaseVersion.substr(
                    5, 1)
            } else if (html5CodebaseVersion.substr(0, 3) === "war" || html5CodebaseVersion.substr(0, 4) ===
                "beta") {
        ...
        var log = function (text, parameters) {
            if (window.console && window.console.log) {
                if (!parameters || typeof parameters.showLogging === "undefined" || parameters.showLogging &&
                    parameters.showLogging !== "false") {
                    console.log(text)
                }
            }
        };
    ...
    var GGBAppletUtils = function () {
        ...
        function getWidthHeight(appletElem, appletWidth, allowUpscale, autoHeight, noBorder,
            scaleContainerClass) {
            var container = null;
            ...
            if (appletElem) {
                if ((allowUpscale === undefined || !allowUpscale) && appletWidth > 0 && appletWidth + border <
                    myWidth) {
                    myWidth = appletWidth
                } else {
                    myWidth -= border
        ...
        function calcScale(parameters, appletElem, allowUpscale, showPlayButton, scaleContainerClass) {
            ...
            var windowSize = getWidthHeight(appletElem, parameters.width, allowUpscale, autoHeight,
                ignoreHeight && window.GGBT_wsf_view || noScaleMargin, scaleContainerClass);
        ...
        function responsiveResize(appletElem, parameters) {
            ...
            if (article) {
                ...
                for (var i = 0; i < appletElem.childNodes.length; i++) {
                    if (appletElem.childNodes[i].className !== undefined && appletElem.childNodes[i].className.match(
                            /^applet_scaler/)) {
                ...
                var appName = parameters.id !== undefined ? parameters.id : "ggbApplet";
                var app = window[appName];
                if ((app == null || !app.recalculateEnvironments) && scaleElem !== null && !scaleElem.className
                    .match(/fullscreen/)) {
    ...
    GGBAppletUtils.makeModule = function (name, permutation) {
        function webModule() {
            ...
            A();
            webModule.__moduleBase = "https://www.geogebra.org/apps/5.2.817.0/" + name + "/";
    ...
    if (typeof window.web3d !== "function") {
        window.web3d = GGBAppletUtils.makeModule("web3d", "1FB6ACFAABB57A17BB5D7F4E21F2D2D4")
    }
    if (typeof window.webSimple !== "function") {
        window.webSimple = GGBAppletUtils.makeModule("webSimple", "DB0416E4DDBF8C97E073E7C6A16D0F16")
    }
